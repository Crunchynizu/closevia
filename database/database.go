...
func ensureIndexes() {
	indexes := []struct {
		...
		{"trades", "idx_trades_buyer_status_created", "buyer_id, status, created_at"},
		{"trades", "idx_trades_seller_status_created", "seller_id, status, created_at"},
		{"trades", "idx_trades_buyer_created", "buyer_id, created_at"},
		{"trades", "idx_trades_seller_created", "seller_id, created_at"},
		{"trades", "idx_trades_parent_status", "parent_trade_id, status"},
